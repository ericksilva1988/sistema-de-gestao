<?php
    ...
    $criaTabelaFornecedor = "create TABLE if not exists `sistema-comercial`.`fornecedor` (`id` INT NOT NULL AUTO_INCREMENT , `empresa` VARCHAR(255) NOT NULL , `cnpj` VARCHAR(255)  , `telefone` VARCHAR(255)  , `email` VARCHAR(255)  , `representacao` VARCHAR(255)  , `representante` VARCHAR(255)  , `observacoes` VARCHAR(1000)  , `id-empresa` INT  , `criado-em` TIMESTAMP  , `atualizado-em` TIMESTAMP NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB";

    $criaTabelaCliente = "create TABLE if not exists `sistema-comercial`.`cliente` (`id` INT NOT NULL AUTO_INCREMENT , `nome` VARCHAR(255) NOT NULL , `apelido` VARCHAR(255)  , `telefone` VARCHAR(255)  , `rua` VARCHAR(300)  , `numero` VARCHAR(300)  , `cep` VARCHAR(255)  , `cidade` VARCHAR(300)  , `estado` VARCHAR(300)  , `referencia` VARCHAR(600)  , `fiado` TINYINT  , `id-empresa` INT  , `criado-em` TIMESTAMP  , `atualizado-em` TIMESTAMP NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB";

    $criarTabelaEmpresa = "create TABLE if not exists `sistema-comercial`.`empresa` (`id` INT NOT NULL AUTO_INCREMENT , `cnpj` VARCHAR(255)  , `empresa` VARCHAR(300) NOT NULL , `nome` VARCHAR(300)  , `endereco` VARCHAR(400)  , `email` VARCHAR(255)  , `telefone` VARCHAR(255)  , `referencia` VARCHAR(600)  , `segmento` VARCHAR(500)  , `criado-em` TIMESTAMP  , `atualizado-em` TIMESTAMP NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB";
